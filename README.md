...
```bash
wget https://github.com/xanderpanderman/ds-cloud-sync/releases/download/v1.0.8/ds2cloudsync-linux-x64 -O ds2cloudsync && chmod +x ds2cloudsync && ./ds2cloudsync
```

**Install to Applications folder**:
```bash
mkdir -p ~/Applications && cd ~/Applications && wget https://github.com/xanderpanderman/ds-cloud-sync/releases/download/v1.0.8/ds2cloudsync-linux-x64 -O ds2cloudsync && chmod +x ds2cloudsync && ./ds2cloudsync
```
